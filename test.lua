local success, errorMessage = pcall(function()
  ...
  local list = {
    [15] = game:GetService("Workspace").Game.Regions.Dion.Areas.AncientRuins.MobsSpots.FeralFiendSoldier,
    [10] = game:GetService("Workspace").Game.Regions.Dion.Areas.AncientRuins.MobsSpots.FeralFiendGeneral
  }
